...
const CERTS = [
  ...
  "Barangay Residency",
  "Business Permit",
  "Natural Death Certificate",
  "Medico-Legal Request",
  "Guardianship Certificate",
  "Co-habitation Certificate",
  "Certification of Same Person",
  "Business Closure",
...
const FEATURES = [
  {
    icon: FileText,
    title: "10+ Certificate Types",
    desc: "All standard barangay documents — clearance, indigency, residency, business permits, and more — processed online.",
  },
  {
    icon: Layers,
    title: "Configurable Workflows",
    desc: "Every barangay has its own process. Add, remove, or reorder approval steps per certificate type — tailored to how your barangay actually works.",
  },
  {
    icon: Bell,
    title: "Email & SMS Notifications",
    desc: "Residents and staff get notified at every step — via email and SMS. No more follow-up calls or missed updates.",
  },
  {
    icon: MessageSquare,
    title: "SMS Alerts",
    desc: "Send SMS updates directly to residents' mobile numbers when their request is approved, ready for pickup, or needs action. Works even without internet.",
  },
  {
    icon: Receipt,
    title: "Official Receipt Generation",
    desc: "Auto-generate PDF official receipts with QR codes. Downloadable and verifiable.",
  },
  {
    icon: ClipboardCheck,
    title: "Physical Inspection Reports",
    desc: "Built-in inspection report module for business permits and other field-verified documents.",
  },
  {
    icon: Fingerprint,
    title: "Digital Signatures & Pickup",
    desc: "Capture digital signatures on release. Track every document from submission to pickup.",
  },
  {
    icon: Search,
    title: "Resident Database Lookup",
    desc: "Search and verify residents instantly during document processing. No manual cross-referencing.",
  },
  {
    icon: QrCode,
    title: "QR Code Scanner",
    desc: "Every resident ID has a unique QR code. During relief operations, staff simply scans the ID — the system logs the claim and blocks duplicates automatically.",
  },
  {
    icon: BarChart3,
    title: "Analytics Dashboard",
    desc: "Track requests, staff performance, and processing times. Export data to Excel or CSV.",
  },
  {
    icon: Globe,
    title: "Public Barangay Website",
    desc: "A full public portal with news, officials directory, facilities, programs, and contact info.",
  },
  {
    icon: Users,
    title: "Officials Directory",
    desc: "Showcase all 26 official positions with photos, descriptions, and visibility controls.",
  },
  {
    icon: Lock,
    title: "Data Privacy Compliant",
    desc: "Fully compliant with RA 10173 (Data Privacy Act). Encrypted, backed up daily, multi-tenant isolated.",
  },
  {
    icon: Globe,
    title: "Cloud-Based",
    desc: "Fully hosted in the cloud. No servers to maintain, no installations. Access from any device, anywhere — your data is always safe and backed up.",
  },
  {
    icon: FileText,
    title: "PDF Certificate Generation",
    desc: "Certificates are auto-generated as professionally formatted PDFs. Ready to print or download instantly after approval.",
  },
  {
    icon: Shield,
    title: "Security Alert Center",
    desc: "Instantly notify admins if a document requester has a pending case or is on a restricted list. Prevents unauthorized certificate issuance.",
  },
];
...
const WORKFLOW_STEPS = [
  {
    num: "01",
    title: "Resident Submits Online",
    desc: "Resident fills out the form on the public portal. Gets a reference number instantly.",
  },
  {
    num: "02",
    title: "Staff Reviews Request",
    desc: "Assigned staff reviews the submission and forwards it for approval.",
  },
  {
    num: "03",
    title: "Secretary & Captain Approve",
    desc: "Barangay Secretary and Captain review and sign off digitally.",
  },
  {
    num: "04",
    title: "Certificate Released",
    desc: "Releasing team notifies the resident. Digital signature captured on pickup.",
  },
];
...
const PLANS = [
  {
    ...
    setup: 5000,
    icon: Zap,
    desc: "For small barangays getting started.",
    highlight: false,
  },
  {
    name: "Standard",
    ...
    setup: 8000,
    icon: Star,
    desc: "Full-featured for active barangays.",
    highlight: true,
  },
  {
    name: "Pro",
    ...
    setup: 10000,
    icon: Crown,
    desc: "Unlimited, for high-volume barangays.",
    highlight: false,
  },
];
...
const FAQS = [
  {
    ...
    a: "Most barangays are live within 3–5 business days. We handle the full setup and provide training.",
  },
  {
    q: "Can residents submit requests from their phones?",
    a: "Yes. The public portal is fully mobile-responsive. Residents can submit from any device.",
  },
  {
    q: "Is this compliant with the Data Privacy Act?",
    a: "Yes. Compliant with RA 10173. All data is encrypted, isolated per barangay, and backed up daily.",
  },
  {
    q: "Can we customize the workflow steps?",
    a: "Absolutely. Each certificate type has its own configurable workflow. Add, remove, or reorder steps.",
  },
  {
    q: "What if we need a certificate type not in the list?",
    a: "We can build custom request forms. Pricing starts at ₱5,000 depending on complexity.",
  },
  {
    q: "Can our LGU deploy this for all barangays?",
    a: "Yes. Our LGU Enterprise plan gives you a centralized dashboard for all barangays under your municipality.",
  },
  {
    q: "Can residents track their application status?",
    a: "Yes. Every resident receives a unique reference number to track their application progress in real-time without logging in.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white landing-page">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100">
        <div
          className="max-w-[1400px] mx-auto px-10 flex items-center justify-between"
          style={{ height: 84 }}
        >
          ...
          <div className="md:hidden bg-white border-t border-gray-100 px-8 py-5 space-y-4">
            {NAV.map((n) => (
              <a
                ...
                className="block text-base text-gray-700 font-medium py-1"
              >
                {n.label}
              </a>
            ))}
            <div className="pt-3 flex flex-col gap-3">
              <button
                onClick={() => router.push("/login")}
                className="w-full py-3 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700"
              >
                Log in
              </button>
              <a
              ...
              <button
                onClick={() => router.push("/pricing")}
                className="btn-gold w-full py-3 rounded-xl text-sm font-semibold text-white"
                style={{
                  background: `linear-gradient(135deg, ${GOLD_DARK}, ${GOLD})`,
                }}
              >
      ...
      <section className="pt-24 pb-16 lg:pt-20 lg:pb-20 px-6 lg:px-8 bg-white overflow-hidden relative">
        ...
        />
        <div
          className={`max-w-[1400px] mx-auto transition-all duration-800 ease-out ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-20 items-start">
            <div className="z-10 relative">
              <p className="text-lg lg:text-xl text-gray-500 leading-relaxed mb-10 max-w-2xl font-medium">
                BrgyDesk gives your barangay a public website, online
                certificate requests, multi-step approval workflows, official
                receipts, and a full admin dashboard — all in one platform.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() => router.push("/pricing")}
                  className="btn-gold flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-semibold text-white"
                  style={{
                    background: `linear-gradient(135deg, ${GOLD_DARK}, ${GOLD})`,
                  }}
                >
                ...
                <button
                  onClick={() => router.push("/login")}
                  className="btn-dark flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-semibold bg-gray-900 text-white"
                >
                  Log in to Dashboard
                </button>
              </div>
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-6 mt-12 pt-10 border-t border-gray-100">
                {[
                  { val: "10+", label: "Certificate Types" },
                  { val: "Multi-Step", label: "Approval Workflow" },
                  { val: "100%", label: "RA 10173 Compliant" },
                  { val: "Multi-Tenant", label: "LGU Ready" },
                ].map((s) => (
                  <div key={s.label}>
            ...
            <div className="hidden lg:block relative lg:-mt-10">
              {/* Background Glow */}
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full blur-[100px] opacity-10 pointer-events-none"
                style={{ background: GOLD }}
              />
              ...
              <div className="absolute -left-12 -bottom-10 z-20 w-1/2 aspect-[4/5] rounded-[1.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.15)] bg-white overflow-hidden hidden sm:block transform -rotate-3 border border-gray-100 hover:rotate-0 transition-transform duration-500 p-3">
                <img
                  src="/images/landing/hero-tablet.png"
                  alt="BrgyDesk Tablet View"
                  className="w-full h-full object-cover rounded-[1rem] shadow-sm"
                />
              </div>
            </div>
      ...
      <section id="features" className="py-28 px-8 bg-gray-50">
        <div className="max-w-[1400px] mx-auto">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mt-3 mb-4 tracking-tight">
              One platform, complete coverage
            </h2>
            <p className="text-lg text-gray-500 max-w-2xl font-medium">
              From online submissions to digital signatures — BrgyDesk handles
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {FEATURES.map((f, i) => {
              ...
              return (
                <div
                  key={i}
                  className="feat-card bg-white rounded-2xl p-7 border border-gray-100 shadow-sm"
                >
                  <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed font-medium">
                Every barangay gets a professional public portal where residents
                can read news, view officials, see facilities, and most
                importantly — request certificates online. It works perfectly on
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100 transform lg:rotate-2 hover:rotate-0 transition-transform duration-700">
                <img
                  src="/images/landing/portal.png"
                  alt="Public Portal Preview"
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100 transform lg:-rotate-2 hover:rotate-0 transition-transform duration-700">
                <img
                  src="/images/landing/qr-scan.png"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed font-medium">
                Streamline relief operations and verify residents instantly.
                Every resident is issued a unique QR code ID. Staff simply scans
                it with any mobile phone — no special equipment needed.
              </p>
              <div className="space-y-4">
                {[
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed font-medium">
                No more manual follow-up calls or missed updates. BrgyDesk
                automatically sends notifications to both residents and barangay
                staff at every stage of the document lifecycle — via both Email
                and SMS.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Residents receive a reference number via SMS immediately after submission.",
                  },
                  {
                    icon: Mail,
                    title: "Email Updates",
                    desc: "Secure links for document tracking and official receipts sent to the resident's inbox.",
                  },
                  {
                    icon: MessageSquare,
                    title: "Pick-up Alerts",
                    desc: "Automated SMS notifying the resident when the document is ready for collection.",
                  },
                ].map((item, i) => {
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="bg-white p-4 rounded-2xl rounded-bl-none shadow-lg border border-gray-100 max-w-[85%] animate-fade-in">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest text-wrap">
                      BrgyDesk SMS
                    </span>
                  </div>
                  <p className="text-sm text-gray-700 font-medium leading-relaxed">
                    Barangay Iba O' Este: Mabuhay! Your{" "}
                    <span className="font-bold text-gray-900">
                      Barangay Clearance
                    </span>{" "}
                    (REF: #B-240322) has been approved and is ready for pickup.
                    See you at the Barangay Hall!
                  </p>
                </div>
                {/* Email Bubble Mock */}
                <div className="bg-gray-950 p-6 rounded-3xl shadow-xl w-full border border-white/5 transform lg:translate-x-12">
                  ...
                  <div className="mt-5 flex justify-end">
                    <div className="px-4 py-1.5 bg-amber-500 text-gray-950 rounded-full text-[10px] font-bold">
                      Document Approved
                    </div>
                  </div>
                </div>
      ...
      <section id="how" className="py-28 px-8 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500 mt-4 max-w-xl mx-auto font-medium">
              The default flow is 4 steps — but every barangay can modify, add,
              or remove steps to match their own process.
            </p>
          </div>
            ...
            {WORKFLOW_STEPS.map((s, i) => (
              <div key={i} className="relative text-center group">
                <div className="w-64 h-40 mx-auto mb-6 bg-gray-100 rounded-2xl overflow-hidden border border-gray-200 flex items-center justify-center">
                  {i < 3 ? (
                    <img
                      src={`/images/landing/step-${i + 1}.png`}
                      alt={s.title}
                ...
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center mx-auto mb-4 font-bold text-sm"
                  style={{
                    background:
                      i === 0
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-gray-100">
                ...
                <div className="space-y-4">
                  {["Dela Cruz, Juan", "Santos, Maria", "Lopez, Antonio"].map(
                    (name, i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-amber-200 transition-colors cursor-pointer group"
                      >
                        <div className="flex items-center gap-4">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed font-medium">
                Eliminate manual record-keeping. Search, verify, and manage your
                residents instantly. Track household relations, verify residency
                status during certificate requests, and keep your records always
                up to date.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  "Instant Verification",
                  "Barangay ID Generation",
                  "Household Mapping",
                  "Pending Case / Restricted Alerts",
                ].map((item) => (
                  <div key={item} className="flex items-center gap-3">
      ...
      <section className="py-28 px-8 bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-3 mb-6 tracking-tight">
            Resident Application Tracker
          </h2>
          <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto font-medium">
            Give your residents peace of mind. Every application generates a
            unique reference number they can use to track real-time progress —
          ...
          <div className="max-w-xl mx-auto bg-white/10 p-2 rounded-[2rem] border border-white/10 flex flex-col sm:flex-row items-center gap-2">
            <input
              ...
              className="w-full bg-transparent px-6 py-4 outline-none text-white font-bold uppercase tracking-widest text-sm"
              readOnly
            />
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-12">
            {[
              ...
              { label: "Ready for Pickup", color: "#10b981" },
            ].map((s) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-400 leading-relaxed mb-8 font-medium">
                Every certificate your barangay issues — available online,
                processed through a configurable approval workflow, and released
        ...
        <div className="max-w-[1400px] mx-auto">
            ...
            {PLANS.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-base text-gray-500 mb-8 leading-relaxed flex-1">
                    {plan.desc}
                  </p>
                  <button
                    onClick={() => router.push("/pricing")}
                    className={`w-full py-3.5 rounded-xl font-semibold text-base transition-all ${plan.highlight ? "btn-gold text-white" : "btn-dark bg-gray-900 text-white"}`}
                    style={
                      plan.highlight
                        ? {
                            background: `linear-gradient(135deg, ${GOLD_DARK}, ${GOLD})`,
          ...
          <div className="bg-gray-900 rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              <div>
                <span className="inline-flex px-3 py-1 bg-amber-500/20 text-amber-500 rounded-full text-xs font-bold uppercase tracking-widest mb-6">
                  Enterprise Suite
                </span>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 tracking-tight">
                  LGU City & Municipality Dashboard
                </h2>
                <p className="text-lg text-gray-400 leading-relaxed font-medium mb-8">
                  Centralized control for Municipal and City governments.
                  Monitor all 26+ barangays in one dashboard, track document
                  volumes, and generate city-wide reports instantly.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
              ...
              <div className="bg-gray-800 rounded-2xl p-6 border border-white/5 shadow-2xl">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="px-3 py-1 bg-white/5 rounded-full text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                    Live Preview
                  </div>
                </div>
                <div className="space-y-4">
                  {[
                    { n: "Active Barangays", v: "26/26" },
                    { n: "Total Requests", v: "15,402" },
                    { n: "Avg. Process Time", v: "1.2 Days" },
                  ].map((s) => (
                    <div
                      key={s.n}
                      className="bg-white/5 rounded-xl p-4 flex items-center justify-between border border-white/5 hover:border-white/10 transition-colors"
                    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 leading-relaxed mb-8 font-medium">
                Explore a fully working demo of BrgyDesk — the public portal,
                certificate request flow, and resident experience. No sign-up
                needed. Just click and explore.
              </p>
            ...
            <div className="relative">
              <div
                ...
                style={{ background: `${GOLD}08`, filter: "blur(60px)" }}
              />
              <div className="relative bg-gray-950 rounded-[2rem] p-8 border border-white/5 shadow-2xl">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={row.label}
                      className="flex items-center justify-between bg-white/5 rounded-xl px-5 py-3.5 border border-white/5"
                    >
          ...
          <div className="space-y-3">
            {FAQS.map((faq, i) => (
              ...
              >
                ...
                <div
                  className={`faq-body px-7 text-base text-gray-500 leading-relaxed border-t border-gray-50 pt-4 pb-6 ${openFaq === i ? "open" : ""}`}
                >
                  {faq.a}
                </div>
              </div>
      ...
      <section className="py-28 px-8 bg-gray-950">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-400 mb-12 leading-relaxed font-medium">
            Get a free walk-through. We'll show you how BrgyDesk can transform
            your operations in days.
          </p>
      ...
      <footer className="bg-gray-950 border-t border-white/5 px-8 py-12">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} BrgyDesk. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
