...
export default function IndigencyCertificateModal({
  isOpen,
  onClose,
  isDemo = false,
}) {
                  ...
                  <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-lg font-bold text-white tracking-tight drop-shadow-md">
                        Certificate of Indigency / Katunayan ng Kakulangan
                      </h2>
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">
                          {referenceNumber || "New Indigency Request"}
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-white/90 font-medium tracking-wide">
                              Verify your registered details / I-verify ang
                              inyong mga detalye
                            </p>
                          </div>
                        </div>
...
const IndigencyPreview = React.memo(
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="w-full space-y-6 text-[15px]">
                  ...
                  <p className="mb-6 leading-relaxed">
                    ...
                    fide resident and their family belongs to the "Indigent
                    Families" of this barangay. Further certifying that their
                    income is not enough to sustain and support their basic
                    needs:
                  </p>
                  ...
                  <div className="mb-8 font-bold text-lg pl-8 underline uppercase">
