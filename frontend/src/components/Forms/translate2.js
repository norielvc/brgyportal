...
const dictionary = {
  ">Registered Business Name":
    ">Registered Business Name / Rehistradong Pangalan ng Negosyo",
  ...
  ">Business Telephone/Mobile":
    ">Business Telephone/Mobile / Telepono o Mobile ng Negosyo",
  ">Business Email Address (Optional)":
    ">Business Email Address (Optional) / Email ng Negosyo (Opsyonal)",
  ">First Name": ">First Name / Pangalan",
  ">Last Name": ">Last Name / Apelyido",
  ">Owner Residential Address":
    ">Owner Residential Address / Tirahan ng May-ari",
  ">Owner Mobile Number": ">Owner Mobile Number / Numero ng Mobile ng May-ari",
  ">Owner Email (Optional)":
    ">Owner Email (Optional) / Email ng May-ari (Opsyonal)",
  ">Detailed Nature of Operations":
    ">Detailed Nature of Operations / Detalyadong Uri ng Operasyon",
  ">Capital Investment (Est. PHP)":
    ">Capital Investment (Est. PHP) / Puhunan (Est. PHP)",
  ">Force size (Employees)": ">Force size (Employees) / Bilang ng Empleyado",
  ">Application Intent": ">Application Intent / Layunin ng Aplikasyon",
  ">Detailed Purpose of Report":
    ">Detailed Purpose of Report / Detalyadong Layunin ng Ulat",
  ">Relationship to Minor":
    ">Relationship to Minor / Relasyon sa Menor de Edad",
  ">Minor Full Name": ">Minor Full Name / Buong Pangalan ng Menor de Edad",
  ">Date of Birth (Minor)":
    ">Date of Birth (Minor) / Petsa ng Kapanganakan (Menor de Edad)",
  ">Purpose of Guardianship":
    ">Purpose of Guardianship / Layunin ng Pagiging Tagapag-alaga",
  ">Purpose of Indigency": ">Purpose of Indigency / Layunin ng Indigency",
  ">Cause of Incident/Injury":
    ">Cause of Incident/Injury / Sanhi ng Insidente o Pinsala",
  ...
  ">Treating Physician/Hospital":
    ">Treating Physician/Hospital / Gagamot na Doktor o Ospital",
  ">Primary Reason for Request":
    ">Primary Reason for Request / Pangunahing Dahilan ng Request",
  ">Educational Attainment": ">Educational Attainment / Antas ng Edukasyon",
  ">School/University Name":
    ">School/University Name / Pangalan ng Paaralan/Unibersidad",
  ...
  ">General Purpose of Certification":
    ">General Purpose of Certification / Pangkalahatang Layunin ng Sertipikasyon",
  "Partner Full Name": "Partner Full Name / Buong Pangalan ng Kapareha",
  ">Years Cohabiting": ">Years Cohabiting / Taon ng Pagsasama",
  "Number of Children (If any)":
    "Number of Children (If any) / Bilang ng mga Anak (Kung mayroon)",
  ...
  ">Claimant Name (Informant)":
    ">Claimant Name (Informant) / Pangalan ng Kumukuha (Impornante)",
  ">Relationship to Deceased":
    ">Relationship to Deceased / Relasyon sa Namatay",
  ">Name Format 1 (e.g. Maiden Name)":
    ">Name Format 1 (e.g. Maiden Name) / Unang Format ng Pangalan (hal. Apelyido sa pagkadalaga)",
  ">Name Format 2 (e.g. Married Name)":
    ">Name Format 2 (e.g. Married Name) / Ikalawang Format ng Pangalan (hal. Apelyido matapos ikasal)",
  ">Reason for Discrepancy":
    ">Reason for Discrepancy / Dahilan ng Pagkakaiba ng Pangalan",
