...
export default function GuardianshipCertificateModal({
  isOpen,
  onClose,
  isDemo = false,
  tenantConfig = {},
              ...
              >
                  ...
                  <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-lg font-bold text-white tracking-tight drop-shadow-md">
                        Guardianship Certificate / Katunayan ng Pangangalaga
                      </h2>
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">
                          {referenceNumber || "New Guardianship Request"}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
                            ...
                            <div>
                              <h3 className="text-base font-bold text-white">
                                Person Under Guardianship (Ward) / Taong Nasa
                                Ilalim ng Pangangalaga
                              </h3>
                              <p className="text-sm text-white/90 font-medium tracking-wide">
                                Person who needs a guardian / Taong
                                nangangailangan ng tagapag-alaga
                              </p>
                            </div>
                          </div>
                          <button
                        ...
                        <div className="relative group">
                          <label className="text-sm font-bold text-gray-400 uppercase tracking-wide ml-1 mb-1 block">
                            Ward Full Name / Buong Pangalan ng Ward
                          </label>
                          <input
                            type="text"
                            ...
                            placeholder="TAP HERE TO SELECT WARD / PUMILI NG WARD MULA SA DIRECTORY..."
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-gray-100 pb-3">
                          <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
                            ...
                            <div>
                              <h3 className="text-base font-bold text-white">
                                Guardian Information / Impormasyon ng
                                Tagapag-alaga
                              </h3>
                              <p className="text-sm text-white/90 font-medium tracking-wide">
                                Person who will be the guardian / Taong magiging
                                tagapag-alaga
                              </p>
                            </div>
                          </div>
                          <button
                            type="button"
                            onClick={() => {
                              setSearchType("guardian");
                              setIsResidentModalOpen(true);
                            }}
                            className="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-[#2d5a3d]/20 text-[#2d5a3d] hover:bg-[#2d5a3d] hover:text-white rounded-lg text-sm font-bold transition-all duration-300 shadow-sm hover:shadow-md group"
                          >
                            <Search className="w-4 h-4 group-hover:scale-110 transition-transform" />
                            Search Guardian Database / Maghanap sa Database ng
                            Guardian
                          </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div className="space-y-1 relative group">
                            <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block">
                              Guardian's Full Name / Buong Pangalan ng
                              Tagapag-alaga{" "}
                            ...
                            <input
                              ...
                              placeholder="TAP HERE TO SELECT GUARDIAN / PUMILI NG GUARDIAN..."
                          ...
                          <div className="space-y-1 relative group">
                            ...
                            <select
                              ...
                              className={`w-full px-4 py-3 bg-white border-2 ${errors.guardianRelationship ? "border-red-500 bg-red-50" : "border-emerald-100"} rounded-lg focus:border-emerald-500 focus:shadow-lg transition-all outline-none font-bold text-gray-800 shadow-sm`}
                            >
                              <option value="">
                                SELECT RELATIONSHIP... / PUMILI NG RELASYON...
                              </option>
                              <option value="PARENT / MAGULANG">
                                PARENT / MAGULANG
                              </option>
                              <option value="GRANDPARENT / LOLO/LOLA">
                                GRANDPARENT / LOLO/LOLA
                              </option>
                              <option value="SIBLING / KAPATID">
                                SIBLING / KAPATID
                              </option>
                              <option value="AUNT/UNCLE / TITA/TITO">
                                AUNT/UNCLE / TITA/TITO
                              </option>
                              <option value="COUSIN / PINSAN">
                                COUSIN / PINSAN
                              </option>
                              <option value="STEP-PARENT / PANGALAWANG MAGULANG">
                                STEP-PARENT / PANGALAWANG MAGULANG
                              </option>
                              <option value="LEGAL GUARDIAN / LIGAL NA TAGAPAG-ALAGA">
                                LEGAL GUARDIAN / LIGAL NA TAGAPAG-ALAGA
                              </option>
                              <option value="OTHER / IBA PA">
                                OTHER / IBA PA
                              </option>
                            </select>
                          </div>
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                          ...
                          <div>
                            <h3 className="text-base font-bold text-white">
                              Contact Information / Impormasyon sa
                              Pakikipag-ugnayan
                            </h3>
                            <p className="text-sm text-white/90 font-medium tracking-wide">
                              Where to receive your updates
                              <span class="hidden sm:inline">
                                {" "}
                                / Kung saan matatanggap ang mga update
                              </span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          <div className="space-y-1 relative group">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-2.5 bg-white border-2 ${errors.contactNumber ? "border-red-500 bg-red-50" : "border-emerald-100"} rounded-lg focus:border-emerald-500 focus:shadow-lg transition-all outline-none font-bold text-gray-800 shadow-sm`}
                            />
                          </div>
                          ...
                          <div className="space-y-1 relative group">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-2.5 bg-white border-2 border-emerald-100 rounded-lg focus:border-emerald-500 focus:shadow-lg transition-all outline-none font-normal text-gray-800 shadow-sm"
                            />
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                          ...
                          <div>
                            <h3 className="text-base font-bold text-white">
                              Application Intent / Layunin ng Aplikasyon
                            </h3>
                            <p className="text-sm text-white/90 font-medium tracking-wide">
                              Purpose of your request / Dahilan ng inyong
                              pagkuha
                            </p>
                          </div>
                        </div>
                        <div className="space-y-4">
                          <div className="space-y-1">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-1 mb-1">
                              <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1">
                                Request Purpose / Dahilan ng Pagkuha{" "}
                                <span className="text-red-500">*</span>
                              </label>
                            ...
                            />
                            <p className="text-sm text-gray-400 font-bold mt-1 italic ml-1">
                              You can select from the dropdowns above or type
                              manually / Maaaring pumili sa listahan o mag-type
                              nang manu-mano
                            </p>
                          </div>
                        </div>
                ...
                <div className="border-t bg-gray-50/80 backdrop-blur-md px-4 py-3 flex flex-col sm:flex-row gap-2 justify-between items-center no-print flex-shrink-0">
                  <p className="text-sm font-bold text-gray-400 uppercase tracking-wide hidden sm:block">
                    Please check all entries before final submission / Pakisuri
                    ang lahat bago i-submit
                  </p>
              ...
              >
                  ...
                  <div className="max-w-2xl mx-auto space-y-4">
                    {Object.entries(formData).map(([key, value]) => {
                      ...
                      return (
                        <div
                          key={key}
                          className="flex flex-col md:flex-row md:items-center justify-between px-6 py-4 bg-white shadow-sm border border-gray-100 rounded-[1.25rem] hover:bg-gray-50 transition-colors group"
                        >
                ...
                <div className="border-t bg-gray-50/80 backdrop-blur-[2px] px-8 py-6 flex flex-col sm:flex-row gap-4 justify-between items-center no-print">
                  <button
                    ...
                    className="px-8 py-3.5 border-2 border-[#2d5a3d]/20 text-[#2d5a3d] hover:bg-[#2d5a3d]/5 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                  >
                    Go Back & Edit / Bumalik sa Pag-edit
                  </button>
                  <button
                    onClick={handleProceedSubmission}
                    disabled={isSubmitting}
                    className="px-8 py-3.5 bg-gradient-to-r from-[#8cc63f] to-[#7cb342] hover:from-[#7cb342] hover:to-[#689f38] text-white rounded-2xl font-extrabold flex items-center justify-center gap-3 shadow-xl transform hover:-translate-y-0.5 transition-all disabled:opacity-75"
                  >
                    {isSubmitting
                      ? "Processing..."
                      : 'Confirm & Submit Application<span class="hidden sm:inline"> / Ipadala ang Aplikasyon</span>'}
                  </button>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-in">
                ...
                <div className="p-6 text-center">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <p className="text-sm text-gray-600 font-bold leading-relaxed">
                          ...
                          application is now in the queue for chairman approval.
                        </p>
                      </div>
                      <div className="flex items-start gap-4">
                        <div className="w-8 h-8 bg-white rounded-xl flex items-center justify-center border border-gray-100 shrink-0 shadow-sm mt-0.5">
                        ...
                        <p className="text-sm text-gray-600 font-bold leading-relaxed">
                          ...
                          <strong>{formData.guardianName}</strong> via{" "}
                          <strong>SMS at {formData.contactNumber}</strong> to
                  ...
                  <button
                    ...
                    className="w-full bg-[#112e1f] hover:bg-[#2d5a3d] text-white py-4 rounded-xl font-bold uppercase tracking-widest transition-all shadow-lg active:scale-95"
                  >
                    Return to Dashboard
                  </button>
                </div>
...
const GuardianshipPreview = React.memo(
      ...
      >
        ...
        >
          ...
          >
            {/* Header */}
            <div
              className="w-full border-b flex justify-center items-center p-8 border-[#1e40af]"
            ...
            >
              ...
              <div className="text-center px-4 flex-1">
                ...
                <p className="text-[18px] font-bold text-[#1e40af] uppercase leading-tight mt-1">
                  {officials.headerInfo?.barangayName}
                </p>
                <p className="text-[14px] font-extrabold text-[#b91c1c] uppercase mt-2">
            ...
            <div className="flex-1 px-16 pt-12 pb-16 flex flex-col relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <h2 className="text-[26px] font-bold mb-12 px-6 uppercase text-[#1e40af] tracking-tight">
                ...
                <div className="w-full space-y-4 md:space-y-6 text-[16px] text-black">
                  ...
                  <div className="space-y-4 mb-10 pl-4">
                    {[
                      ...
                      [
                        "Date of Birth",
                        formatDate(formData.dateOfBirth)?.toUpperCase(),
                      ],
                      [
                      ...
                      <div
                        key={label}
                        className="grid grid-cols-[220px_10px_1fr] items-baseline"
                      >
                  ...
                  <p className="mb-6 leading-relaxed text-justify">
                    Issued this <span className="font-bold">{currentDate}</span>{" "}
                    at Barangay Iba O' Este, Calumpit, Bulacan upon the request
                    of above mentioned persons for any legal purposes it may
                    serve.
                  </p>
                  ...
                  >
                    <div className="mb-4">
                      <div className="h-8 w-64 border-b border-black"></div>
                      <p className="text-sm mt-1">
                        Resident's Signature / Thumb Mark
                      </p>
                    </div>
                    <div className="self-start text-left">
                      <p className="font-bold text-[16px] mb-[130px]">
                        TRULY YOURS,
                      </p>
                      <p className="text-[22px] font-bold uppercase leading-tight text-[#1e40af]">
                        {officials.chairman}
                      </p>
                      <p className="text-sm font-bold mt-1 uppercase text-gray-700">
                        BARANGAY CHAIRMAN
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-auto">
                <div className="text-right mb-4 opacity-50">
                  <p className="text-sm italic">
                    Reference No:{" "}
                    <strong className="font-bold">{referenceNumber}</strong>
                  </p>
                </div>
                <div className="border-t-2 border-gray-300 pt-2 opacity-50">
                  <p className="text-sm text-gray-600">
                    Address: {officials.contactInfo?.address}
                  </p>
                </div>
              </div>
            </div>
