...
export default function ResidencyCertificateModal({
  isOpen,
  onClose,
  isDemo = false,
}) {
  ...
  useEffect(() => {
    ...
    if (savedOfficials) {
      ...
      setOfficials({
        ...
        countryStyle: {
          ...defaultOfficials.countryStyle,
          ...parsed.countryStyle,
        },
        provinceStyle: {
          ...defaultOfficials.provinceStyle,
          ...parsed.provinceStyle,
        },
        municipalityStyle: {
          ...defaultOfficials.municipalityStyle,
          ...parsed.municipalityStyle,
        },
        barangayNameStyle: {
          ...defaultOfficials.barangayNameStyle,
          ...parsed.barangayNameStyle,
        },
        officeNameStyle: {
          ...defaultOfficials.officeNameStyle,
          ...parsed.officeNameStyle,
        },
        sidebarStyle: {
          ...defaultOfficials.sidebarStyle,
          ...parsed.sidebarStyle,
        },
  ...
  const handleProceedSubmission = async () => {
    ...
    try {
      ...
      setNotification({
        ...
        message:
          error.message || "Could not submit application. Please try again.",
      });
    } finally {
        ...
        {!showConfirmationPopup && !showSuccessModal && (
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 sm:p-10">
              ...
              <div
                className="relative bg-white rounded-2xl shadow-2xl w-full max-w-6xl flex flex-col overflow-hidden animate-fade-in no-scrollbar"
                style={{
                  minHeight: "800px",
                  height: "90vh",
                  ...
                  <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-lg font-bold text-white tracking-tight drop-shadow-md">
                        Barangay Residency / Katunayan ng Paninirahan
                      </h2>
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">
                          {referenceNumber || "New Residency Request"}
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-white/90 font-medium tracking-wide">
                              Auto-filled via community database / Awtomatikong
                              napupuno sa database
                            </p>
                          </div>
                        </div>
                        <button
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-gray-600 font-bold leading-relaxed">
                          ...
                          confirm your pickup schedule at the Barangay Hall.
                        </p>
                      </div>
                    </div>
                  </div>
...
const ResidencyPreview = React.memo(
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <div
              className="w-full border-b flex justify-center items-center p-8 flex-shrink-0"
              style={{
            ...
            >
              ...
              <div className="text-center px-4">
                ...
                <p className="text-[18px] font-bold text-blue-800 uppercase leading-tight mt-1">
                  {officials.headerInfo?.barangayName}
                </p>
                <p className="text-[14px] font-extrabold text-red-700 uppercase mt-2">
            ...
            <div className="flex-1 px-16 pt-8 pb-16 flex flex-col relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <h2 className="text-[24px] font-bold mb-10 px-4 uppercase text-[#004d40]">
                ...
                <div className="w-full space-y-6 text-[15px]">
                  ...
                  <p className="mb-6 leading-relaxed">
                    This is to certify that below mentioned person is a bona
                    fide resident of this barangay as detailed below:
                  </p>
                  <div className="space-y-1 mb-8">
                    {[
                      ...
                      <div
                        key={label}
                        className="grid grid-cols-[180px_10px_1fr] items-baseline text-black"
                      >
                  ...
                  <div className="mb-8">
                    <p className="mb-2 italic">
                      Issued upon the request of the above-named person for:
                    </p>
                    <p className="font-bold text-lg pl-8 underline">
                      {formData.purpose?.toUpperCase() || "NOT SPECIFIED"}
                    </p>
                  </div>
                  <p className="mb-8">
                    Issued this {currentDate} at Barangay Iba O' Este, Calumpit,
                    Bulacan.
                  </p>
                  <div className="mt-0 flex flex-col">
                    ...
                    <div className="self-start text-left">
                      <p className="font-bold text-[15px] mb-[130px] uppercase">
                        Truly Yours,
                      </p>
                      <p className="text-[20px] font-bold uppercase underline leading-tight text-black">
                        {officials.chairman}
                      </p>
              ...
              <div className="w-full text-right mt-auto mb-2 opacity-60">
                <p className="text-sm italic">
                  Ref No: <strong>{referenceNumber}</strong>
                </p>
              </div>
