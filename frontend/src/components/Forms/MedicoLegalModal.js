...
export default function MedicoLegalModal({
  isOpen,
  onClose,
  isDemo = false,
  tenantConfig = {},
  ...
  const handleProceedSubmission = async () => {
    ...
    try {
      ...
      const refNum = `ML-${new Date().getFullYear()}-${timestamp}`;
                  ...
                  <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-lg font-bold text-white tracking-tight drop-shadow-md">
                        Request for Medico Legal / Hiling para sa Medico Legal
                      </h2>
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">
                          {referenceNumber || "New Medico Legal Request"}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-white/90 font-medium tracking-wide">
                              Person requiring medico legal certification
                            </p>
                          </div>
                        </div>
                        <button
                      ...
                      <div className="relative">
                        <label className="text-sm font-bold text-gray-400 uppercase tracking-wide ml-1 mb-1 block">
                          Patient Full Name / Buong Pangalan ng Pasyente{" "}
                    ...
                    <div className="space-y-4 pt-4 border-t border-gray-100">
                      <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-white/90 font-medium tracking-wide">
                            Case reference and schedule information
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-1">
                          <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block flex items-center gap-1">
                            <Calendar className="w-3 h-3" /> Date of Examination
                            / Petsa ng Pagsusuri{" "}
                            <span className="text-red-500">*</span>
                          </label>
                          <input
                        ...
                        <div className="space-y-1">
                          <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block flex items-center gap-1">
                            <FileText className="w-3 h-3" /> Usaping Barangay
                        ...
                        <div className="space-y-1">
                          <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block flex items-center gap-1">
                            <Calendar className="w-3 h-3" /> Date of Hearing /
                            Petsa ng Pagdinig{" "}
                            <span className="text-red-500">*</span>
                          </label>
                          <input
                    ...
                    <div className="space-y-4 pt-4 border-t border-gray-100">
                      ...
                      <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 flex gap-3 items-start shadow-sm">
                        ...
                        <p className="text-sm text-amber-800 font-medium leading-relaxed">
                          <span className="font-bold">Note / Paunawa:</span> The
                          Barangay Administrator will contact you via this
                          number regarding the official status or schedule of
                          your request. / Makikipag-ugnayan ang Barangay
                          Administrator sa numerong ito patungkol sa estado o
                          iskedyul ng inyong request.
                        </p>
                      </div>
                    </div>
                  </form>
