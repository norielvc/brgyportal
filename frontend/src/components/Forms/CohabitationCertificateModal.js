...
export default function CohabitationCertificateModal({
  isOpen,
  onClose,
  isDemo = false,
  tenantConfig = {},
  ...
  const [formData, setFormData] = useState({
    ...
    partnerGender: "",
    partnerDateOfBirth: "",
    partnerResidentId: null,
    address: "",
    noOfChildren: "0",
    livingTogetherYears: "0",
  ...
  const handleResidentSelect = (resident) => {
    if (selectingFor === "person1") {
      ...
      setFormData((prev) => ({
        ...
        partnerDateOfBirth: resident.date_of_birth
          ? new Date(resident.date_of_birth).toISOString().split("T")[0]
          : "",
  ...
  const handleProceedSubmission = async () => {
    ...
    try {
      ...
      const refNum = `CH-${new Date().getFullYear()}-${timestamp}`;
        ...
        <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-sm text-white/90 font-medium tracking-wide">
              Select from resident directory
            </p>
          </div>
        </div>
        <button
          type="button"
          onClick={() => {
            setSelectingFor(nameKey === "fullName" ? "person1" : "person2");
              ...
              >
                  ...
                  <div className="flex items-center gap-3 relative z-10">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-lg font-bold text-white tracking-tight drop-shadow-md">
                        Co-habitation Certificate / Katunayan ng
                        Pakikipagsamahan
                      </h2>
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        <p className="text-white text-sm font-bold uppercase tracking-wide px-2 py-0.5 bg-red-600 rounded-md shadow-md">
                          {referenceNumber || "New Cohabitation Request"}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                  <form onSubmit={handleSubmit} className="p-4 space-y-6">
                    ...
                    <ResidentBlock
                      nameKey="fullName"
                      label="First Person / Unang Tao"
                      btnLabel="Search Resident Directory / Maghanap sa Directory"
                      person="1"
                    />
                    ...
                    <div className="pt-4 border-t border-gray-100">
                      <ResidentBlock
                        nameKey="partnerFullName"
                        label="Partner Details / Detalye ng Kapareha"
                        btnLabel="Search Partner Directory / Maghanap sa Directory ng Kapareha"
                        person="2"
                      />
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-100 space-y-4">
                      <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                        ...
                        <div>
                          <h3 className="text-base font-bold text-white">
                            Co-habitation Details / Detalye ng Pakikipagsamahan
                          </h3>
                          <p className="text-sm text-white/90 font-medium tracking-wide">
                            Common address and duration of living together
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block flex items-center gap-1">
                          <MapPin className="w-3 h-3" /> Common Address /
                          Pinasamang Tirahan{" "}
                        ...
                        <input
                          ...
                          placeholder="Full address where both parties are living together..."
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div className="space-y-1">
                          <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block flex items-center gap-1">
                            <Users className="w-3 h-3" /> No. of Children /
                            Bilang ng Anak
                          </label>
                          <input
                            type="number"
                            ...
                            onChange={handleInputChange}
                            className={inputClass("noOfChildren")}
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block">
                            Years Together / Taon na Magkasama
                          </label>
                          <input
                            type="number"
                            min="0"
                            name="livingTogetherYears"
                            value={formData.livingTogetherYears}
                            onChange={handleInputChange}
                            className={inputClass("livingTogetherYears")}
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="text-sm font-bold text-[#2d5a3d] uppercase tracking-wide ml-1 block">
                            Months Together / Buwan na Magkasama
                          </label>
                          <input
                            type="number"
                            min="0"
                            max="11"
                            name="livingTogetherMonths"
                            value={formData.livingTogetherMonths}
                            onChange={handleInputChange}
                            className={inputClass("livingTogetherMonths")}
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-100 space-y-4">
                      <div className="flex items-center gap-3 bg-gradient-to-r from-[#8cc63f] to-[#b4d339] rounded-l-full rounded-r-lg p-1.5 pr-4 shadow-sm mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-white/90 font-medium tracking-wide">
                            Where to receive updates / Saan tatanggap ng mga
                            update
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-12 pr-4 py-2.5 bg-white border-2 border-emerald-100 rounded-lg focus:border-emerald-500 focus:shadow-lg transition-all outline-none font-normal text-gray-800 shadow-sm"
                            />
                          </div>
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar px-4 py-4 bg-gray-50/80">
                  <div className="max-w-2xl mx-auto space-y-3">
                    {Object.entries(formData).map(([key, value]) => {
                      ...
                      if (!value || value === "0" || excludedKeys.includes(key))
                        return null;
                      const labelMap = {
                        fullName: "Person 1 Full Name",
                        partnerFullName: "Partner Full Name",
                        address: "Common Address",
                        noOfChildren: "No. of Children",
                        livingTogetherYears: "Years Together",
                        livingTogetherMonths: "Months Together",
                        purpose: "Purpose",
                ...
                <div className="border-t bg-gray-50/80 px-4 py-3 flex flex-col sm:flex-row gap-2 justify-between items-center">
                  <button
                    ...
                    className="px-4 py-2.5 border-2 border-[#2d5a3d]/20 text-[#2d5a3d] hover:bg-[#2d5a3d]/5 rounded-lg font-bold flex items-center gap-2 outline-none"
                  >
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="px-4 py-2.5 bg-gradient-to-r from-[#8cc63f] to-[#7cb342] hover:from-[#7cb342] hover:to-[#689f38] text-white rounded-lg font-bold flex items-center gap-2 shadow-xl transform hover:-translate-y-0.5 transition-all"
                  >
