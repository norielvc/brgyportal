...
const dictionary = {
  ...
  "Review your application before syncing":
    "Review your application before syncing / Suriin ang aplikasyon bago i-sync",
  ...
  ">Verified Profile System<":
    ">Verified Profile System / Sistema ng Beripikadong Profile<",
  ">All details have been validated against the official directory.<":
    ">All details have been validated against the official directory. / Lahat ng detalye ay napatunayan sa opisyal na direktoryo.<",
