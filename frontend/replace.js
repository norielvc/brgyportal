const fs = require('fs');
const filePath = 'c:/Users/SCREENS/OneDrive/Desktop/Admin dashboard/frontend/pages/index.js';
let content = fs.readFileSync(filePath, 'utf8');

const edRegex = /( {6}\{\/\* Educational Assistance Program Section - SK Project - Trimmed for single screen \*\/}[\s\S]*?<\/section>\r?\n\r?\n)( {6}\{\/\* Barangay Achievement and Awards Section \*\/})/;
...
const facRegex = /( {6}\{\/\* Facilities Section - Enhanced Modern Design \*\/}[\s\S]*?<\/section>\r?\n\r?\n\r?\n)( {6}\{\/\* Barangay Clearance Modal \*\/})/;
