...
export default function ProgramsPage() {
  ...
  useScrollLock(Boolean(editingProgram || showAddModal));
      ...
      try {
        ...
        if (json.success) {
          ...
          if (isStarterPlan) {
            ...
            window.location.href = "/dashboard?upgrade=programs";
          }
        }
      } catch (e) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center justify-between gap-2.5 sm:gap-4 w-full">
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
          <button
            ...
            className="flex-1 sm:flex-none px-3.5 sm:px-4 py-2 sm:py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs sm:text-sm font-bold flex items-center justify-center gap-1.5 sm:gap-2 shadow-md shadow-indigo-200 active:scale-95 transition-all"
          >
      ...
      {/* Edit Modal */}
      {editingProgram && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[60] p-4" onTouchMove={(e) => e.target === e.currentTarget && e.preventDefault()}>
