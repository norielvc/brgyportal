...
const FEATURES = [
  {
    ...
    desc: "10+ document types processed online",
  },
  {
    icon: ClipboardList,
    label: "Workflow Approvals",
    desc: "Multi-step configurable approval system",
  },
  {
    icon: Users,
    label: "Resident Directory",
    desc: "Searchable community database",
  },
  {
    icon: Globe,
    label: "Multi-Tenant Ready",
    desc: "One platform for many barangays",
  },
  {
    icon: Building2,
    label: "Official Receipts",
    desc: "Digital OR generation & tracking",
  },
  {
    icon: CheckCircle,
    label: "Real-Time Status",
    desc: "Live request tracking for residents",
  },
];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push(
          data.data.user?.role === "SuperAdmin" ? "/superadmin" : "/dashboard",
        );
      } else {
            ...
            <div className="relative bg-slate-900/40 backdrop-blur-3xl rounded-[2.5rem] border border-white/10 p-8 sm:p-12 space-y-8 shadow-[0_30px_60px_rgba(0,0,0,0.6)]">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-slate-400 text-sm font-semibold italic tracking-wide">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between pb-2">
                  ...
                  <button
                    type="button"
                    className="text-sm text-amber-200/80 hover:text-amber-200 font-bold transition-colors"
                  >
                    Reset Password?
                  </button>
                </div>
