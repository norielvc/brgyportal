...
export default function VerifyPickupPage() {
  ...
  const handleConfirmPickup = async () => {
    if (!pickedUpBy.trim()) {
      toast.error(
        "Please enter the name of the person picking up the certificate",
      );
      return;
    }
    ...
    try {
      ...
      const body = token
        ? { token, pickedUpBy: pickedUpBy.trim() }
        : { ref, pickedUpBy: pickedUpBy.trim() };
      ...
      if (data.success) {
        ...
        toast.success(
          `Success! Certificate ${ref || ""} is now marked as picked up.`,
          {
            duration: 5000,
            style: {
              minWidth: "350px",
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 mb-6">
              The certificate has been successfully marked as picked up by{" "}
              <strong>{pickedUpBy}</strong>.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 mb-6">
              {verification?.message ||
                "The pickup code is invalid or the certificate could not be found."}
            </p>
            {verification?.pickedUpAt && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-yellow-800">
                  This certificate was already picked up on{" "}
                  {formatDate(verification.pickedUpAt)}.
                </p>
              </div>
            )}
            <button
  ...
  const pickup = verification.pickup || {
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
            <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-white mb-2">
                Certificate Pickup Verification
              </h1>
              <p className="text-green-100">
                Verify and confirm certificate pickup
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-500">
                  Valid until {formatDate(pickup.expires_at)}
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    ...
                    <li>
                      • Only the applicant or authorized representative can pick
                      up
                    </li>
          ...
          <div className="text-center text-sm text-gray-500">
            ...
            <p>
              For assistance, contact the barangay office during office hours
            </p>
          </div>
        </div>
      </div>
