...
const faqs = [
  {
    ...
    a: "Yes, we offer a 30-day demo so you can see the system live before committing.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Compliant with RA 10173. Data is encrypted and backed up daily.",
  },
  {
    q: "Do you provide on-site training?",
    a: "Yes. On-site training is available. Online training via Zoom/Meet is included in all plans.",
  },
  {
    q: "Can we add certificate types not in the list?",
    a: "Yes, through our Custom Request Form add-on. Pricing depends on complexity.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-white font-sans pricing-page">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100">
        <div
          className="max-w-[1400px] mx-auto px-8 h-18 flex items-center justify-between"
          style={{ height: "68px" }}
        >
          ...
          <div className="flex items-center gap-8">
            <a
              href="#addons"
              className="text-base text-gray-400 hover:text-gray-900 transition-colors hidden sm:block"
            >
              Add-ons
            </a>
            <a
                  ...
                  <div className="p-10 flex-1 flex flex-col">
                    ...
                    {plan.highlight === "platinum" ? (
                      <button
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${PLATINUM_DARK}, ${PLATINUM})`,
                        }}
                      >
        ...
        <div ref={addonsRef} className="reveal max-w-[1400px] mx-auto pt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {addons.map((group, gi) => (
              <div
                key={gi}
                className="addon-card bg-white rounded-2xl border border-gray-100 p-9 shadow-sm"
              >
                ...
                <div className="space-y-1">
                  {group.items.map((item, ii) => (
                    ...
                    >
                      ...
                      <span
                        className="text-base font-bold ml-4 shrink-0"
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                <div
                  className={`faq-answer px-7 text-base text-gray-500 leading-relaxed border-t border-gray-50 pt-4 pb-6 ${openFaq === i ? "open" : ""}`}
                >
                  {faq.a}
                </div>
              </div>
      ...
      <section className="py-28 px-8 bg-gray-950">
        <div ref={ctaRef} className="reveal max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-12 text-lg leading-relaxed">
            Contact us for a free demo. We will walk you through the system and
