        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="p-10 rounded-[3rem] bg-white border border-gray-100 shadow-2xl shadow-gray-200/50 relative overflow-hidden group hover:shadow-primary-100/50 transition-all duration-500">
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-8">
                    <div
                      className={`p-5 rounded-[2rem] bg-gray-900 text-white shadow-xl`}
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-gray-50">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-extrabold text-gray-900 uppercase text-base tracking-tight">
                          {typeInfo.label}
                        </p>
                      </div>
                    </div>
                    ...
                    history
                      ...
                      .map((step, index) => (
                        <div key={index} className="flex gap-8 relative group">
                          <div
                            className={`w-12 h-12 rounded-[1.25rem] flex items-center justify-center shrink-0 border-4 border-white shadow-xl relative z-10 transition-transform group-hover:scale-110 ${
                              step.action === "approve"
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <h4 className="font-black text-gray-900 uppercase text-base tracking-tight leading-none mb-1">
                                  {step.step_name}
                                </h4>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl overflow-hidden p-8">
                ...
                <div className="space-y-6">
                  <div className="p-5 bg-gray-50 rounded-[2rem] border border-gray-100">
                    <p className="text-[14px] font-black text-gray-900 uppercase tracking-tight mb-1">
              ...
              <div
                className={`p-8 rounded-[2.5rem] border-4 shadow-2xl transition-all duration-500 ${
              ...
              >
                <h3 className="text-[11px] font-black text-white/70 uppercase tracking-[0.2em] mb-6">
                  Government Guidance
                </h3>
                ...
                request.status === "ready_for_pickup" ? (
                  <div className="space-y-6">
                    ...
                    <div className="p-5 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                      <p className="text-[10px] font-black uppercase tracking-widest mb-3 border-b border-white/10 pb-2">
                        Claim Checklist
                      </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-[12px] font-bold text-white/70 uppercase leading-relaxed tracking-tight font-medium">
                      Our staff is currently verifying your details. This
                      standard process takes 24-48 hours.
                    </p>
