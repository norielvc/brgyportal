    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {selectedAchievement && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm" onClick={() => setSelectedAchievement(null)}>
          <div className="bg-indigo-950 border border-indigo-400/20 rounded-2xl md:rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden relative transform transition-all" onClick={e => e.stopPropagation()}>
            <button onClick={() => setSelectedAchievement(null)} className="absolute top-4 right-4 z-20 w-8 h-8 flex items-center justify-center rounded-full bg-black/40 text-white hover:bg-red-500 transition-colors backdrop-blur-md">
              <X className="w-5 h-5" />
            </button>
            <div className="relative h-48 sm:h-64 lg:h-80 w-full group overflow-hidden">
            ...
            <div className="p-6 md:p-8 relative z-20 -mt-8 md:-mt-12 bg-indigo-950/80 backdrop-blur-md border-t border-indigo-500/20">
              ...
              <p className="text-indigo-100/90 leading-relaxed text-base md:text-lg mt-4">
