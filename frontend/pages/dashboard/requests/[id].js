...
const TYPE_CONFIG = {
  ...
  barangay_cohabitation: {
    label: "Cohabitation Certificate",
    icon: Heart,
    color: "rose",
  },
  medico_legal: {
      ...
      <Layout title="Request Not Found" requireAuth={true}>
        <div className="max-w-md mx-auto mt-12 text-center p-8 bg-white rounded-3xl border border-gray-100 shadow-xl">
          ...
          <p className="text-gray-500 text-sm mb-6 leading-relaxed uppercase font-bold tracking-tight">
            We couldn't find a request with the provided ID. Please double-check
            the URL or reference number.
          </p>
          <button
            onClick={() => router.back()}
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Status Hero Card */}
            <div
              className={`p-8 rounded-[2.5rem] bg-white border border-gray-100 shadow-xl shadow-gray-200/50 relative overflow-hidden`}
            >
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div
                    className={`p-4 rounded-3xl bg-${statusInfo.color}-50 text-${statusInfo.color}-600 border border-${statusInfo.color}-100`}
                  >
                  ...
                  <div>
                    ...
                    <h1
                      className={`text-4xl font-black text-${statusInfo.color}-700 uppercase tracking-tighter leading-none`}
                    >
                      {statusInfo.label}
                    </h1>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-50">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-extrabold text-gray-900 uppercase text-sm tracking-tight">
                        {typeInfo.label}
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-8 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-[2px] before:bg-gray-100">
                ...
                {history.length > 0 ? (
                  history
                    ...
                    .map((step, index) => (
                      <div key={index} className="flex gap-6 relative group">
                        <div
                          className={`w-10 h-10 rounded-2xl flex items-center justify-center shrink-0 border-4 border-white shadow-md relative z-10 transition-transform group-hover:scale-110 ${
                            step.action === "approve"
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2 flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
                              Personnel:{" "}
                              {step.users
                                ? `${step.users.first_name} ${step.users.last_name}`
                                : "System"}
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="flex gap-6 relative">
                    ...
                    <div>
                      <h4 className="font-black text-gray-900 uppercase text-sm tracking-tight leading-none mb-2">
                        Initial Review
                      </h4>
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-4 px-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[12px] font-bold text-gray-700 uppercase tracking-tight leading-relaxed">
                        {request.address || "N/A"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[12px] font-black text-gray-700 font-mono tracking-tighter">
                  ...
                  {[
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] font-bold text-gray-700 uppercase tracking-tight">
            ...
            <div
              className={`p-6 rounded-[2rem] border shadow-lg ${
            ...
            >
              <h3 className="text-[10px] font-black text-white/70 uppercase tracking-[0.2em] mb-4">
                Command Guidance
              </h3>
              ...
              request.status === "ready_for_pickup" ? (
                <div className="space-y-4">
                  <p className="text-sm font-bold uppercase tracking-tight leading-relaxed">
                    Your request is now READY! Please proceed to the Barangay
                    Hall during business hours to claim your document.
                  </p>
                  <div className="p-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                    <p className="text-[10px] font-black uppercase tracking-widest mb-2 border-b border-white/10 pb-2">
                      Requirements
                    </p>
                ...
                <div className="space-y-4">
                  <p className="text-sm font-bold uppercase tracking-tight leading-relaxed">
                    Your application is currently being processed by our staff.
