...
export default function CertificateLayoutPage() {
  ...
  const insertPlaceholder = (placeholder) => {
    ...
    const currentContent =
      officials.templates?.[previewType]?.[activeTemplateField] || "";
    const newContent =
      currentContent + (currentContent.endsWith(" ") ? "" : " ") + placeholder;
    ...
    setNotification({
      type: "success",
      message: `Added ${placeholder} to ${activeTemplateField}`,
    });
  };
      ...
      try {
        ...
        if (data.success && data.data) {
          setOfficials((prev) => ({
            ...
            countryStyle: {
              ...prev.countryStyle,
              ...(data.data.countryStyle || {}),
            },
            provinceStyle: {
              ...prev.provinceStyle,
              ...(data.data.provinceStyle || {}),
            },
            municipalityStyle: {
              ...prev.municipalityStyle,
              ...(data.data.municipalityStyle || {}),
            },
            barangayNameStyle: {
              ...prev.barangayNameStyle,
              ...(data.data.barangayNameStyle || {}),
            },
            officeNameStyle: {
              ...prev.officeNameStyle,
              ...(data.data.officeNameStyle || {}),
            },
            templates: {
              indigency: {
                ...(prev.templates?.indigency || {}),
                ...(data.data.templates?.indigency || {}),
              },
              clearance: {
                ...(prev.templates?.clearance || {}),
                ...(data.data.templates?.clearance || {}),
              },
              residency: {
                ...(prev.templates?.residency || {}),
                ...(data.data.templates?.residency || {}),
              },
            },
          }));
        }
  ...
  const saveField = (field) => {
    ...
    if (field.startsWith("header_")) {
      ...
      setOfficials({
        ...officials,
        headerInfo: { ...officials.headerInfo, [key]: value },
      });
      setHasChanges(true);
      setEditingField(null);
      ...
      setOfficials({
        ...officials,
        contactInfo: { ...officials.contactInfo, [key]: value },
      });
      setHasChanges(true);
      setEditingField(null);
        ...
        {isEditing ? (
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-500 font-semibold"
              autoFocus
              onKeyDown={(e) => {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-purple-50 rounded-2xl p-6 border border-purple-200">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {officials.logos?.leftLogo && (
                        <button
                          ...
                          className="px-4 py-2 bg-red-100 text-red-600 rounded-lg text-sm flex items-center gap-2 hover:bg-red-200"
                        >
                  ...
                  <div className="flex items-center gap-6">
                    <div className="w-32 h-40 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50 overflow-hidden shadow-inner">
                      {officials.logos?.captainImage ? (
                        <img
                          src={officials.logos.captainImage}
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          ref={captainImageRef}
                          accept="image/*"
                          onChange={(e) => handleLogoUpload("captain", e)}
                          className="hidden"
                        />
                        <button
              ...
              <div className="mt-4">
                <SizeSlider
                  label="Logo Size"
                  value={officials.logos?.logoSize || 115}
            ...
            <div className="bg-pink-50 rounded-2xl p-6 border border-pink-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <EditableField
                  label="Country"
                  field="header_country"
                  value={officials.headerInfo?.country}
                  icon={Globe}
                />
                <EditableField
                  label="Province"
                  field="header_province"
                  value={officials.headerInfo?.province}
                  icon={MapPin}
                />
                <EditableField
                  label="Municipality"
                  field="header_municipality"
                  value={officials.headerInfo?.municipality}
                  icon={Building}
                />
                <EditableField
                  label="Barangay Name"
                  field="header_barangayName"
                  value={officials.headerInfo?.barangayName}
                  icon={Shield}
                />
                <div className="md:col-span-2">
                  <EditableField
                    label="Office Name"
                    field="header_officeName"
                    value={officials.headerInfo?.officeName}
                    icon={Building}
                  />
                </div>
              </div>
            ...
            <div className="bg-indigo-50 rounded-2xl p-6 border border-indigo-200">
              ...
              {[
                ...
                <div key={type} className="bg-white rounded-xl p-4 border mb-4">
                  <span className="font-medium text-gray-700 capitalize mb-2 block">
                    {type.replace(/([A-Z])/g, " $1").trim()} Style
                  </span>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <ColorPicker
                      label="Color"
                      value={officials[`${type}Style`]?.color || "#000000"}
                      onChange={updateStyle}
                      section={`${type}Style`}
                      field="color"
                    />
                    <SizeSlider
                      label="Size"
                      value={officials[`${type}Style`]?.size || 12}
                      onChange={updateStyle}
                      section={`${type}Style`}
                      field="size"
                      min={8}
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-3">
                      ...
                      <select
                        value={
                          officials[`${type}Style`]?.fontWeight || "normal"
                        }
                        onChange={(e) =>
                          updateStyle(
                            `${type}Style`,
                    ...
                    <FontSelect
                      label="Font"
                      value={officials[`${type}Style`]?.fontFamily || "default"}
                      onChange={updateStyle}
                      section={`${type}Style`}
                      field="fontFamily"
                    />
              ...
              <div className="bg-gray-100 rounded-xl p-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <ColorPicker
                    label="Background"
                    value={officials.headerStyle?.bgColor || "#ffffff"}
                    onChange={updateStyle}
                    section="headerStyle"
                    field="bgColor"
                  />
                  <ColorPicker
                    label="Border Color"
                    value={officials.headerStyle?.borderColor || "#1e40af"}
                    onChange={updateStyle}
                    section="headerStyle"
                    field="borderColor"
                  />
                  <SizeSlider
                    label="Logo Spacing"
                    value={officials.headerStyle?.logoSpacing || 0}
                    onChange={updateStyle}
                    section="headerStyle"
                    field="logoSpacing"
                    min={0}
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-200">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-lg border border-blue-100">
                  ...
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${officials.sidebarStyle?.showSidebar ? "translate-x-6" : "translate-x-1"}`}
                    />
                  </button>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                ...
                <ColorPicker
                  label="Text Color"
                  value={officials.sidebarStyle?.textColor}
                  onChange={updateStyle}
                  section="sidebarStyle"
                  field="textColor"
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <SizeSlider
                  label="Name Size"
                  value={officials.sidebarStyle?.textSize}
                  onChange={updateStyle}
                  section="sidebarStyle"
                  field="textSize"
                  min={8}
                ...
                <div className="bg-white p-3 rounded-xl border">
                  ...
                  <select
                    value={officials.sidebarStyle?.letterSpacing || "normal"}
                    onChange={(e) =>
                      updateStyle(
                        "sidebarStyle",
                        "letterSpacing",
              ...
              {officials.sidebarStyle?.showSidebar ? (
                <div
                  ...
                  style={{
                    ...
                    letterSpacing:
                      officials.sidebarStyle?.letterSpacing === "tighter"
                        ? "-0.05em"
                        : officials.sidebarStyle?.letterSpacing === "wide"
                          ? "0.025em"
                          : officials.sidebarStyle?.letterSpacing === "widest"
                            ? "0.1em"
                            : "normal",
                  }}
                >
                  <div className="text-center">
                    ...
                    <p
                      className="font-bold"
                      style={{
                        fontSize: `${officials.sidebarStyle?.textSize}px`,
                      }}
                    >
                      {officials.chairman}
                    </p>
          ...
          <div className="space-y-6">
            <div className="bg-emerald-50 rounded-2xl p-6 border border-emerald-200">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <ColorPicker
                  label="Background"
                  value={officials.bodyStyle?.bgColor}
                  onChange={updateStyle}
                  section="bodyStyle"
                  field="bgColor"
                />
                <ColorPicker
                  label="Text Color"
                  value={officials.bodyStyle?.textColor}
                  onChange={updateStyle}
                  section="bodyStyle"
                  field="textColor"
                />
                <ColorPicker
                  label="Title Color"
                  value={officials.bodyStyle?.titleColor}
                  onChange={updateStyle}
                  section="bodyStyle"
                  field="titleColor"
                />
                <SizeSlider
                  label="Title Size"
                  value={officials.bodyStyle?.titleSize}
                  onChange={updateStyle}
                  section="bodyStyle"
                  field="titleSize"
                  min={18}
                ...
                <SizeSlider
                  ...
                  value={officials.bodyStyle?.textSize}
                  onChange={updateStyle}
                  section="bodyStyle"
                  field="textSize"
                  min={10}
                ...
                <FontSelect
                  label="Font"
                  value={officials.bodyStyle?.fontFamily}
                  onChange={updateStyle}
                  section="bodyStyle"
                  field="fontFamily"
                />
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-200">
              ...
              <div className="bg-white p-3 rounded-xl border mb-4">
                ...
                <p className="text-[10px] text-gray-400 mt-1">
                  Click a field below, then click a placeholder to add it.
                </p>
              </div>

              <div className="space-y-4">
                <div
                  className={`bg-white rounded-xl p-4 border space-y-3 transition-colors ${activeTemplateField === "title" ? "ring-2 ring-blue-100 border-blue-300" : ""}`}
                >
                ...
                <div
                  className={`bg-white rounded-xl p-4 border space-y-3 transition-colors ${activeTemplateField === "intro" ? "ring-2 ring-blue-100 border-blue-300" : ""}`}
                >
                  <label className="text-sm font-medium text-gray-700 block">
                    Salutation / Intro
                  </label>
                ...
                <div
                  className={`bg-white rounded-xl p-4 border space-y-3 transition-colors ${activeTemplateField === "body1" ? "ring-2 ring-blue-100 border-blue-300" : ""}`}
                >
                  <label className="text-sm font-medium text-gray-700 block">
                    First Paragraph / Certification Text
                  </label>
                  <textarea
                    rows={3}
                ...
                {previewType === "indigency" && (
                  <div
                    className={`bg-white rounded-xl p-4 border space-y-3 transition-colors ${activeTemplateField === "body2" ? "ring-2 ring-blue-100 border-blue-300" : ""}`}
                  >
                    <label className="text-sm font-medium text-gray-700 block">
                      Second Paragraph
                    </label>
                ...
                <div
                  className={`bg-white rounded-xl p-4 border space-y-3 transition-colors ${activeTemplateField === "purpose" ? "ring-2 ring-blue-100 border-blue-300" : ""}`}
                >
                  <label className="text-sm font-medium text-gray-700 block">
          ...
          <div className="space-y-6">
            <div className="bg-amber-50 rounded-2xl p-6 border border-amber-200">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <ColorPicker
                  label="Background"
                  value={officials.footerStyle?.bgColor}
                  onChange={updateStyle}
                  section="footerStyle"
                  field="bgColor"
                />
                <ColorPicker
                  label="Text Color"
                  value={officials.footerStyle?.textColor}
                  onChange={updateStyle}
                  section="footerStyle"
                  field="textColor"
                />
                <ColorPicker
                  label="Border Color"
                  value={officials.footerStyle?.borderColor}
                  onChange={updateStyle}
                  section="footerStyle"
                  field="borderColor"
                />
                <SizeSlider
                  label="Text Size"
                  value={officials.footerStyle?.textSize}
                  onChange={updateStyle}
                  section="footerStyle"
                  field="textSize"
                  min={8}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  <EditableField
                    ...
                    value={officials.contactInfo?.address}
                    icon={MapPin}
                  />
                </div>
                <EditableField
                  label="Contact Person"
                  field="contact_contactPerson"
                  value={officials.contactInfo?.contactPerson}
                  icon={UserCog}
                />
                <EditableField
                  label="Telephone"
                  field="contact_telephone"
                  value={officials.contactInfo?.telephone}
                  icon={Phone}
                />
                <div className="md:col-span-2">
                  <EditableField
                    label="Email"
                    field="contact_email"
                    value={officials.contactInfo?.email}
                    icon={Mail}
                  />
                </div>
              </div>
        ...
        {activeTab === "preview" && (
          <div className="bg-gray-100 p-8 rounded-2xl overflow-auto border flex flex-col items-center">
            ...
            >
              {/* Header Section */}
              <div
                className="w-full border-b flex justify-center items-center p-8"
                style={{
              ...
              >
                ...
                <div className="text-center flex flex-col justify-center">
                  <p
                    style={{
                      color: officials.countryStyle?.color,
                      fontSize: `${officials.countryStyle?.size}px`,
                      fontWeight: officials.countryStyle?.fontWeight,
                      fontFamily: officials.countryStyle?.fontFamily,
                    }}
                  >
                    {officials.headerInfo?.country}
                  </p>
                  <p
                    style={{
                      color: officials.provinceStyle?.color,
                      fontSize: `${officials.provinceStyle?.size}px`,
                      fontWeight: officials.provinceStyle?.fontWeight,
                      fontFamily: officials.provinceStyle?.fontFamily,
                    }}
                  >
                  ...
                  <p
                    style={{
                      color: officials.municipalityStyle?.color,
                      fontSize: `${officials.municipalityStyle?.size}px`,
                      fontWeight: officials.municipalityStyle?.fontWeight,
                      fontFamily: officials.municipalityStyle?.fontFamily,
                    }}
                  >
                  ...
                  <p
                    className="mt-1"
                    style={{
                      color: officials.barangayNameStyle?.color,
                      fontSize: `${officials.barangayNameStyle?.size}px`,
                      fontWeight: officials.barangayNameStyle?.fontWeight,
                      fontFamily: officials.barangayNameStyle?.fontFamily,
                    }}
                  >
                  ...
                  <p
                    style={{
                      color: officials.officeNameStyle?.color,
                      fontSize: `${officials.officeNameStyle?.size}px`,
                      fontWeight: officials.officeNameStyle?.fontWeight,
                      fontFamily: officials.officeNameStyle?.fontFamily,
                    }}
                  >
                    {officials.headerInfo?.officeName}
                  </p>
                </div>
              ...
              <div className="flex flex-1 relative">
                ...
                {officials.sidebarStyle?.showSidebar && (
                  <div
                    className="w-64 p-6 flex flex-col text-center"
                    style={{
                      background: `linear-gradient(to bottom, ${officials.sidebarStyle?.bgColor}, ${officials.sidebarStyle?.gradientEnd})`,
                      color: officials.sidebarStyle?.textColor,
                    }}
                  >
                    ...
                    <div className="mb-6">
                      ...
                      <p
                        style={{
                          fontSize: `${officials.sidebarStyle?.textSize}px`,
                          fontWeight:
                            officials.sidebarStyle?.nameWeight || "bold",
                        }}
                      >
                        {officials.chairman}
                      </p>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {["Kagawad One", "Kagawad Two", "Kagawad Three"].map(
                          (k, i) => (
                            <p
                              key={i}
                              className="mb-1"
                              style={{
                                fontSize: `${(officials.sidebarStyle?.textSize || 12) - 1}px`,
                              }}
                            >
                              {k}
                            </p>
                ...
                {/* Document Body */}
                <div
                  className="flex-1 px-12 pt-6 pb-12 relative"
                  style={{ backgroundColor: officials.bodyStyle?.bgColor }}
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    <h2
                      className="text-center font-bold mb-10 border-b-2 inline-block pb-4 px-8 uppercase leading-normal"
                      style={{
                    ...
                    >
                      {officials.templates?.[previewType]?.title ||
                        (previewType === "indigency"
                    ...
                    >
                      <div className="flex justify-between items-center mb-8">
                        <p>
                          <strong>
                            {officials.templates?.[previewType]?.intro ||
                      ...
                      {previewType === "indigency" ? (
                        <div className="w-full text-left">
                          <p className="mb-8 leading-relaxed whitespace-pre-wrap">
                            ...
                            !officials.templates?.indigency?.body1.includes(
                              "[NAME]",
                            )
                              ? officials.templates?.indigency?.body1
                              : 'This is to certify that below mentioned person is a bona fide resident and their family belongs to the "Indigent Families" of this barangay as of date mentioned below. Further certifying that their income is not enough to sustain and support their basic needs:'}
                          ...
                          <div className="mb-6 space-y-1 pl-4">
                            ...
                            <div className="grid grid-cols-[160px_10px_1fr]">
                              ...
                              <span>:</span>
                              <span className="font-bold uppercase">25</span>
                            </div>
                            <div className="grid grid-cols-[160px_10px_1fr]">
                            ...
                            <div className="grid grid-cols-[160px_10px_1fr]">
                              ...
                              <span>:</span>
                              <span className="font-bold uppercase">
                                {officials.contactInfo?.address || "PUROK 1"}
                              </span>
                            </div>
                            <div className="grid grid-cols-[160px_10px_1fr]">
                              <span className="font-semibold">
                          ...
                          <p className="mb-2 leading-relaxed whitespace-pre-wrap">
                            ...
                            !officials.templates?.indigency?.purpose.includes(
                              "[PURPOSE]",
                            )
                              ? officials.templates?.indigency?.purpose
                              : "This certification is being issued upon the request of above mentioned person for below purpose(s):"}
                          ...
                          <p className="mb-12">
                            ...
                            at {officials.headerInfo?.barangayName},{" "}
                            {officials.headerInfo?.municipality},{" "}
                            {officials.headerInfo?.province}.
                          </p>
                          ...
                          <div className="w-full text-right mt-auto mb-2 text-xs">
                            <p>
                              Ref No: <strong>BRGY-2026-00001</strong>
                            </p>
                          </div>
                          ...
                          <div className="clear-both pt-1 border-t border-gray-400 w-full text-xs text-left">
                            ...
                            <p>
                              ...
                              {officials.contactInfo?.contactPerson} (
                        ...
                        <div className="flex flex-col gap-4 text-left w-full">
                          <p className="text-left mb-8 whitespace-pre-wrap leading-relaxed">
                            {previewType === "clearance"
                              ? officials.templates?.clearance?.body1 ||
                                "This is to certify that below mentioned person is a bona fide resident of this barangay and has no derogatory record as of date mentioned below:"
                              : officials.templates?.residency?.body1 ||
                                "This is to certify that below mentioned person is a bona fide resident of this barangay as detailed below:"}
                          </p>
                            ...
                            <table className="w-full text-left">
                              <tbody>
                                {[
                                  ...
                                  <tr key={idx}>
                                    <td className="font-semibold py-1 w-48 align-top text-gray-700">
                                      {row.label}
                                    </td>
                                    <td className="font-bold py-1 align-top uppercase flex text-gray-900">
                          ...
                          <div className="mb-4">
                            <p className="whitespace-pre-wrap mb-2">
                              {officials.templates?.[previewType]?.purpose ||
                                "This certification is being issued upon the request of above mentioned person for below purpose(s):"}
                            </p>
                          ...
                          <p className="mb-12">
                            ...
                            <span className="capitalize">
                              {officials.headerInfo?.barangayName?.toLowerCase()}
                            </span>
                            , {officials.headerInfo?.municipality},{" "}
                            {officials.headerInfo?.province}.
                          </p>
